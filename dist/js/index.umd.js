    ...
    return (function () {
        ...
        return (
                ...
                (h = Math.min(h, 96e3)),
                    ...
                    (this.processor.onmessage = function (t) {
                        var a = t.data,
                            e = a.audioData,
                            s = a.pcmAudioData;
                        i.audioDatas.push(e), i.pcmAudioDatas.push(s), 1 === i.audioDatas.length && o && 'init' === i.status && i.play();
                    });
            }),
            ...
            (t.prototype.stop = function () {
                ...
                try {
                    null === (t = this.bufferSource) || void 0 === t || t.stop(), null === (i = this.onStop) || void 0 === i || i.call(this, this.audioDatas);
                } catch (t) {
                    console.log(t);
                }
            }),
            (t.prototype.getAudioDataBlob = function (t) {
                ...
                if (null === (a = this.pcmAudioDatas) || void 0 === a ? void 0 : a.length)
                    return 'wav' === t ? i(this.pcmAudioDatas, this.fromSampleRate, 16) : ((e = this.pcmAudioDatas), new Blob(e, { type: 'audio/pcm' }));
            }),
            t
        );
    })();
